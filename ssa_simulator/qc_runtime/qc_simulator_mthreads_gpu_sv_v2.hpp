...
namespace SimulatorMooreThreadGPUSVV2TypeDef {
...
class SimulatorMooreThreadGPUSVV2 : public SimulatorV2 {
public:
  SimulatorMooreThreadGPUSVV2(std::uint64_t nQubits_ = 0UL);
  ~SimulatorMooreThreadGPUSVV2() override;
...
private:
  using Unitary1QType = SimulatorMooreThreadGPUSVV2TypeDef::Unitary1QType;
  ...
  // MUSA data structures
  int _mDeviceID{0};
  musaDeviceProp _mDeviceProp;

  std::vector<muFloatComplex> _mHostStateVector;
  std::vector<muFloatComplex> _mHostStateVectorBuffer;
  float* _mDeviceOutput{nullptr};

  muFloatComplex* _mDeviceStateVector{nullptr};
  muFloatComplex* _mDeviceStateVectorBuffer{nullptr};

  musaEvent_t _mEventStart{nullptr};
  musaEvent_t _mEventStop{nullptr};

  musaFuncAttributes _mApplyGateOneFunctionAttrs;
  musaFuncAttributes _mFindProbabilityOfOutcomeZeroFunctionAttrs;
  musaFuncAttributes _mCollapseToOutcomeScaleFunctionAttrs;
  musaFuncAttributes _mStoreStateVectorFunctionAttrs;
  musaFuncAttributes _mDotStateVectorFunctionAttrs;
  musaFuncAttributes _mNormStateVectorFunctionAttrs;
